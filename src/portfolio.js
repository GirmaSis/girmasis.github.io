...
import RippleLoadingAnimation_gs from "./assets/lottie/RippleLoadingAnimation_gs"; // Rename to your file name for custom animation
...
const socialMediaLinks = {
  ...
  googleScholar: "https://scholar.google.com/citations?user=CEGtZ-YAAAAJ&hl=en",
  // intentionally removed/omitted: medium, stackoverflow, twitter, facebook, kaggle, instagram, gitlab
  display: true
};
  ...
  schools: [
    {
      ...
      // Use JSX so we can style labels & links cleanly
      desc: (
        <div className="ed-desc">
          ...
          <div className="ed-links" style={{ marginTop: 6 }}>
            ...
            >
              arXiv • Computer Vision and Pattern Recognition • AfricaNLP 2020 Workshop
            </a>
      ...
      descBullets: [
        (
          <span>
            <span className="ed-label"><strong>Final grade:</strong>
              
            </span>{" "}
            3.75/4.00 with <strong> Excellent </strong> thesis result           <br />
    ...
    },
    {
      ...
      desc:
        "Ranked top 5% in the program. Took courses about Software Engineering, Web Security, Operating Systems, ...",
...
const contactInfo = {
  ...
  number: "+2519 8383 8989",
  email_address: "sisaygirma97@gmail.com"
};
